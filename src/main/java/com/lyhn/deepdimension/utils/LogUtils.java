...
public class LogUtils {
    // 业务日志记录器，记录业务相关日志
    private static final Logger BUSINESS_LOGGER = LoggerFactory.getLogger("com.lyhn.deepdimension.business");

    // 性能日志记录器，记录系统性能相关日志
    private static final Logger PERFORMANCE_LOGGER = LoggerFactory.getLogger("com.lyhn.deepdimension.performance");
    ...
    public static void logBusiness(String operation, String userId, String message, Object... args) {
        try {
            // MDC是SLF4J提供的线程本地变量容器，用于在日志中添加上下文信息
