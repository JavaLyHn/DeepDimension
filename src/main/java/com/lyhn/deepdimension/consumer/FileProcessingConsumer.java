package com.lyhn.deepdimension.consumer;

import com.lyhn.deepdimension.config.KafkaConfig;
import com.lyhn.deepdimension.model.FileProcessingTask;
import com.lyhn.deepdimension.service.ParseService;
import com.lyhn.deepdimension.service.VectorizationService;
...
public class FileProcessingConsumer {
    ...
    // 所有分片合并完成后发送解析任务到kafka，kafka消费任务，根据文件类型选择相应解析器提取文本，并且将提取的文本向量化存储到Elasticsearch
    ...
    public void processTask(FileProcessingTask task) {
        ...
        try {
            ...
            // 强制转换为可缓存流（将不支持标记/重置的流包装为 BufferedInputStream）
