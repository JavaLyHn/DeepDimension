package com.lyhn.deepdimension.controller;
...
import com.lyhn.deepdimension.service.FileTypeValidationService;
import com.lyhn.deepdimension.service.UploadService;
...
public class UploadController {
    ...
    public ResponseEntity<Map<String, Object>> mergeFile(
        ...
        try {
            ...
            //ObjectUrl 是合并后的文件在Minio中的一个临时路径
            ...
            //为什么使用kafka，这样可以在合并完之后将返回直接响应给用户，而不是等待文件处理完成
